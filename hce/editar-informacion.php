...
$sql=mysqli_query($con,"Update usuarios set fullName='$fname',address='$address',city='$city',gender='$gender' where id='".$_SESSION['id']."'");
if($sql)
{
...
<p><b>Fecha de la última actualización: </b><?php echo htmlentities($data['updationDate']);?></p>
<?php } ?>
...
<div class="form-group">
					...
					<a href="agregar-email.php">Actualizar email</a>
														</div>
