...
if(isset($_POST['submit']))
  {
   ...
   $pres=$_POST['pres'];
      ...
      $query.=mysqli_query($con, "insert   historiamedica(PatientID,BloodPressure,BloodSugar,Weight,Temperature,MedicalPres)value('$vid','$bp','$bs','$weight','$temp','$pres')");
    if ($query) {
    echo '<script>alert("Se ha agregado el historial del médico.")</script>';
    echo "<script>window.location.href ='administar-pacientes.php'</script>";
  }
  else
    {
...
<html lang="en">
	<head>
		<title>Administar pacientes</title>
...
<div class="row">
<div class="col-sm-8">
<h1 class="mainTitle">Administrar pacientes</h1>
</div>
<ol class="breadcrumb">
<li>
<span>Doctor</span>
...
<div class="row">
<div class="col-md-12">
<h5 class="over-title margin-bottom-15">Administar <span class="text-bold">Pacientes</span></h5>
<?php
                               $vid=$_GET['viewid'];
                               $ret=mysqli_query($con,"select * from tablapacientes where ID='$vid'");
$cnt=1;
...
Información del paciente</td></tr>
    ...
    <tr>
    <th scope>Nombre del pacientes</th>
    <td><?php  echo $row['PatientName'];?></td>
    <th scope>Email</th>
    <td><?php  echo $row['PatientEmail'];?></td>
  </tr>
  <tr>
    <th scope>Número de contacto</th>
  ...
  <tr>
    ...
    <th>Historial médico(Si lo hay)</th>
...
$ret=mysqli_query($con,"select * from historiamedica  where PatientID='$vid'");
