...
$patage=$_POST['patage'];
$medhis=$_POST['medhis'];
$sql=mysqli_query($con,"update tablapacientes set PatientName='$patname',PatientContno='$patcontact',PatientEmail='$patemail',PatientGender='$gender',PatientAdd='$pataddress',PatientAge='$patage',PatientMedhis='$medhis' where ID='$eid'");
if($sql)
{
echo "<script>alert('Informacion actualizada correctamente');</script>";
header('location:administar-pacientes.php');
...
<div class="row">
<div class="col-sm-8">
<h1 class="mainTitle">Editar información</h1>
</div>
<ol class="breadcrumb">
<li>
<span>Paciente</span>
...
<h5 class="panel-title">Agregar pacientes</h5>
</div>
<div class="panel-body">
<form role="form" name="" method="post">
<?php
 $eid=$_GET['editid'];
$ret=mysqli_query($con,"select * from tablapacientes where ID='$eid'");
$cnt=1;
