...
{
$ret=mysqli_query($con,"SELECT * FROM administrador WHERE username='".$_POST['username']."' and password='".$_POST['password']."'");
				...
				<div class="box-login">
					<form class="form-login" method="post">
						<fieldset>
							...
							<p>
							Por favor ingrese su nombre y clave para entrar.<br />
