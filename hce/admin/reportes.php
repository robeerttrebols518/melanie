				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">Consultar fechas</h1>
																	</div>
								<ol class="breadcrumb">
									<li>
										...
										<div class="col-lg-8 col-md-12">
											<div class="panel panel-white">
												<div class="panel-heading">
													<h5 class="panel-title">Informes entre fechas seleccionadas</h5>
												</div>
												<div class="panel-body">
									
													<form role="form" method="post" action="detalles-reporte.php">
