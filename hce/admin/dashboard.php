									...
									<div class="panel panel-white no-radius text-center">
										<div class="panel-body">
											...
											<p class="links cl-effect-1">
												...
												<?php $result = mysqli_query($con,"SELECT * FROM usuarios");
								...
								<div class="col-sm-4">
									<div class="panel panel-white no-radius text-center">
										<div class="panel-body">
											...
											<h2 class="StepTitle">Administar Doctores</h2>
										
											<p class="cl-effect-1">
												<a href="gestion-doctores.php">
												<?php $result1 = mysqli_query($con,"SELECT * FROM doctores ");
										...
										<div class="panel-body">
											...
											<p class="links cl-effect-1">
												<a href="book-appointment.php">
													<a href="historias-citas.php">
												<?php $sql= mysqli_query($con,"SELECT * FROM citasHist");
...
<div class="col-sm-4">
									<div class="panel panel-white no-radius text-center">
										<div class="panel-body">
											...
											<p class="links cl-effect-1">
												<a href="gestion-pacientes.php">
<?php $result = mysqli_query($con,"SELECT * FROM tablapacientes");
$num_rows = mysqli_num_rows($result);
{
?>
			...
			<div class="col-sm-4">
									<div class="panel panel-white no-radius text-center">
										<div class="panel-body">
											...
											<p class="links cl-effect-1">
												<a href="book-appointment.php">
													<a href="consultas-no-leidas.php">
												<?php 
$sql= mysqli_query($con,"SELECT * FROM tablaContacto where  IsRead is null");
